...
class Matriz extends LH_Controller {
	...
	public function index()
	{
		...
		$this->load->view('Matriz_view',$this->scope);
	...
	{
		if($this->Matriz_model->obtenerCirculoActivo($this->session->userdata('id_usuario')) == NULL)
		{
			redirect('/dashboard' ,'refresh');
		}
