            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Pago mensual <small>Realiza tu pago de 40$ para obtener acceso a la academia</small>
                            </h2>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Pago 100$ <small>Realiza tu pago de 100$ - Obtienes los beneficios de la academia y ingresas a nuestro multinivel interno</small>
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <!--<div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect pagar-con-btc" id-tipo="3">Donar con BTC</button>
                                ...
                                <div class="col-md-12" style="display: flex;align-items: center;justify-content: center;"> 
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect pagar-con-btc" id-tipo="3">Pagar con</button> 
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Pago 100$ + 40$ Mensualidad <small>Realiza tu pago de 140$ - Asi obtendras acceso a la academia (con sus beneficios) y pagarias tu mensualidad inmediatamente</small>
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <!--<div class="col-md-12">
                                    <button type="button" class="btn btn-primary waves-effect pagar-con-btc" id-tipo="4">Donar con BTC</button>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Pago 1000$ <small>Realiza tu pago de 1000$ - Obtienes los beneficios de la academia y ingresas a nuestro multinivel interno</small>
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12" style="display: flex;align-items: center;justify-content: center;"> 
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect pagar-con-btc" id-tipo="8">Pagar con</button> 
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form>
                                ...
                                <div class="alert alert-danger">Recuerde agregar el Hash id de la transaccion</div>
