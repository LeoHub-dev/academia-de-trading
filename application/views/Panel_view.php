                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-ganancias-total" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                                    ...
                                    <?php $n = 0; foreach((array) $lista_ganancias_admin as $ganancia) : ?>
                                        <tr role="row">
                                            ...
                                            <td><?php if($ganancia->pagada == 0) : ?><button type="button" class="btn bg-green btn-circle waves-effect waves-circle waves-float mercar-pagado" id-ganancia="<?= $ganancia->id_ganancia; ?>"><i class="material-icons">done</i></button><?php else : ?>Pagada<?php endif; ?></td>
                                        </tr>
                                    <?php $n++; endforeach; ?>
