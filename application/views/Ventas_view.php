		    ...
		    <div class="collapse navbar-collapse" id="main-navbar" >
			  <div class="nav" style="display: inline">
				...
				<a class="navbar-brand smoothScroll" href="#home">
					<img alt="Academia De Trading" src="<?= asset_url(); ?>/ventas/img/logo.png" style="display: inline;"><img alt="Academia De Trading" src="<?= asset_url(); ?>/ventas/img/logo-texto.png" style="display: inline;">
				</a>
				</div>
		...
		<section id="explicacion" class="bg-1">
			...
			<div class="container-fluid not-so-fluid">
				...
				<div>
					...
					<h3 class="clearfix font-white medium" style="margin-top: 40px; margin-bottom: 40px;text-align: center; position: relative;">Comience a Invertir en Criptomonedas Sin Ser Experto y Sin Arriesgar Su Dinero</h3>
					...
					<div class="title-content clearfix">
						...
						<div id="home-video-text">
							...
							<div class="col-md-7" id="home-video">
								...
								<h3 class="clearfix font-yellow" style="margin-top: 40px; margin-bottom: 40px;text-align: center; position: relative;">Comprobado: 9 de Cada 10 de nuestros Estudiantes Ganan Dinero Diariamente</h3>
							...
							<div class="clearfix">
								...
								<div class="col-md-12 font-white">
									<div class="col-md-2">
										...
										<img src="<?= asset_url(); ?>ventas/img/fotochic.png" class="img-responsive">
									</div>
									<div class="col-md-10">
										<div class="col-md-12">
