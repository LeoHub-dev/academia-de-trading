...
<header id="header">
    ...
    <div class="collapse navbar-collapse" id="main-navbar">
        <ul class="nav navbar-nav">
            <li class="active">
                <a class="smoothScroll" href="<?= base_url() ?>#home">Home <span class="sr-only">(current)</span></a>
            </li>
            <li><a class="smoothScroll" href="http://tradingcoin.us/">TradingCoin</a></li>
            <li><a class="smoothScroll" href="<?= base_url() ?>#planes">Planes</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if ($info_usuario == FALSE) : ?>
                        <form id="login-form" class="auth-form" action="<?= site_url('auth/ingreso'); ?>"
                  ...
                  <span class="input-group-addon">
                    <i class="material-icons">lock</i>
                            ...
                            <div class="col-md-12">
                                <div id="error_message" class="alert alert-danger clearfix" style="display: none;"
                                     role="alert">
                                    Bad
                                </div>
                                <div id="success_message" class="alert alert-success clearfix" style="display: none;"
                                     role="alert">
                                    Good
                                </div>
                            </div>
                        ...
                        <form id="register-form-ventas" class="auth-form" action="<?= site_url('auth/registro'); ?>"
                              method="POST">
                  ...
                  <span class="input-group-addon">
                    <i class="material-icons">lock</i>
                                ...
                                <div class="form-line">
                                    <input type="password" class="form-control" name="confirmar_password" minlength="6"
                            ...
                            <div class="form-group">
                                ...
                                <label for="terminos">Lei y estoy de acuerdo con los <a href="<?= site_url('legal'); ?>"
                                                                                        target="_blank">terminos de
                                        uso</a>.</label>
                            </div>
                            ...
                            <div class="m-t-25 m-b--5 align-center">
                                <a class="auth-link" data-href="login-form" href="javascript:void(0)">Ya estas
                                    registrado ?</a>
                            </div>
                        </form>
                    ...
                    <div class="pago-ventas-view" <?php if ($info_usuario == FALSE) : ?> style="display: none;" <?php endif; ?>>
                        ...
                        <div class="row">
                            <div class="alert alert-success">
                                <p>
                                    ...
                                    <small id="payment_form_nombre"><?= ($info_usuario != FALSE) ? $info_usuario['data']->nombre . ' ' . $info_usuario['data']->apellido : ''; ?></small>
                                </p>
                                <p>
                                    <small class="font-weight-bold">Email :</small>
                                    <small id="payment_form_email"><?= ($info_usuario != FALSE) ? $info_usuario['data']->email : ''; ?></small>
                                </p>
                                <p><a href="<?= site_url('auth/desconectarse'); ?>" style="color: black">* Desconectar
                                        esta cuenta</a></p>
                            </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12" style="display: flex;align-items: center;justify-content: center;">
                                ...
                                <button type="button" class="btn btn-primary waves-effect pagar-con-general"
                                        id-tipo="6">Pagar con
                                </button>
                    ...
                    <div class="col-md-6" id="home-video">
                        <div class=" ifra embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item"
                                    src="https://player.vimeo.com/video/245812578?title=0&amp;byline=0&amp;portrait=0;autoplay=0"
    ...
    <section id="" class="bg-gris">
        <div class="container-fluid not-so-fluid">
                    ...
                    <div class="col-md-12 some-margin">
                        ...
                        <div class="col-md-7" style="margin: 0 auto;float: none">
                            <div class="el-content"
                                 style="width: 400px; margin: 0px auto; max-width: 100%; padding-top: 8px; padding-bottom: 8px;">
                                <div class="ib2-hline"
                                     style="width: 400px; max-width: 100%; height: 10px; border-top: 2px dotted rgb(49, 1, 1);"></div>
                            </div>

                            <div class=" text-justify p-texto">
                                <p>
                                    En esta oportunidad, amigo mio quiero decirte que si es posible obtener estas
                                    <span class="text-back-yellow"><b>espectaculares ganancias de  manera pasiva</b></span>
                                    con <b>la minería de criptomonedas</b>,
                                ...
                                <p>
                                    Te voy a guiar <b>PASO A PASO</b> durante los 4 modulos y te revelaré mi método con
                                    el que consigo diariemente
                                    ganar desde <span class="text-back-yellow"><b>$500 dolares al día</b></span>, con la
                                    mineria POS y los Master Nodes.
                                </p>
                            </div>
                            <div class="el-content"
                                 style="width: 400px; margin: 0px auto; max-width: 100%; padding-top: 8px; padding-bottom: 8px;margin-bottom: 20px;">
                                <div class="ib2-hline"
                                     style="width: 400px; max-width: 100%; height: 10px; border-top: 2px dotted rgb(49, 1, 1);"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="margin: 0 auto;float: none;">
                            <div class="p-texto text-justify">
                                <p>
                                    ...
                                    En pocas palabras es un servidor que se encuentra en la red de la
                                    criptomoneda.<br><br>

                                    Explicandolo de manera sencilla, es un monedero o wallet de la criptomoneda
                                    especifica
                                    que tiene un número fijo de criptomonedas, este número lo suministra la criptomoneda
                                    para
                                    poder crear el master node, estas monedas no se pueden utilizar pues con ella es que
                                    se realizan
                                    las operaciones que requiere el master node.<br><br>

                                    Ese monedero trabaja las 24 horas del día y las criptomonedas nos recompensan por
                                    ese trabajo,
                                    de montar y configurar el master node y mantener las monedas requeridas en el mismo.<br><br>

                                    Lo mejor es que son <b>ingresos pasivos</b> para sus operadores o dueños ya, que los
                                    block chain o
                                    cadena de bloques pagan cierta cantidad de monedas o dinero, diariamente al dueño
                                    del master
                                    node, ese pago los hace en la moneda con la que se configuro el master node, o en la
                                    moneda
                                    invertida para crear el master node.<br><br>

                                    Una de las ventajas es que si la moneda sube su precio, aumenta el pago por mantener
                                    activo el mismo.
                                </p>
                                <p>
                                    <span class="titulo-parrafo text-back-yellow">Puedo ser dueño de un master node?</span><br><br>

                                    Si, <b>cualquier persona puede tener su propio master node configurado</b> y
                                    rentando miles de dólares, el
                                    costo es variable teniendo en cuenta en la criptomoneda en la que va a invertir,
                                    algunas monedas
                                    piden tener 100 monedas para ser dueño de un master node, otras piden 1000 o mas,
                                    ese valor lo
                                    multiplicas por el valor de la moneda y esto te da el valor que debes invertir para
                                    configurar
                                    tu master node. <br><br>

                                    Gracias a los master nodes muchas monedas como Dash han logrado incrementar su
                                    valor, y hoy dia son
                                    muchisimas las criptomonedas que tienen implementada la creacion de master nodes a
                                    particulares.
                                </p>
                                <p>
                                    <span class="titulo-parrafo text-back-yellow">Como Gano Dinero con master nodes?</span><br><br>
                                    Las criptomonedas que permiten la creación de los master nodes, te dan recompensas
                                    monetaria en su divisa
                                    (En la propia Moneda) a quienes son los operadores de master nodes, es de allí que
                                    salen los
                                    altos porcentajes que vas a recibir por configurar tu propio master node. <br><br>

                                    También puedes <b>configurar masternodes a terceros</b> y ofrecer este servicio, en
                                    donde ganas por cada master
                        ...
                        <div class="col-md-12" style="margin: 0 auto;float: none; margin-top: 30px;">
                            <div class="col-md-8" style="margin: 0 auto;float: none; margin-bottom: 30px;">
                                <h2 style="font-size: 40px;line-height: 60px;">
                                    <span class="back-color-blue">Mentoria PERSONALIZADA Paso a Paso</span> que te va a
                                    enseñar a
            ...
            <div class="container-fluid not-so-fluid" style="padding: 0">
                        ...
                        <div class="col-md-8" style="margin: 0 auto; float: none">
                            ...
                            <div class="col-md-8">
                                <ul class="item-modulos">
                                    ...
                                    <li><span>Como escoger y poder invertir en los masternode  mas rentables.</span>
                                    </li>
                                    <li><span>Primeros pasos para la configuración de los masternode.</span></li>
                                    <li><span>Donde y cual VPS adquirir para el masternodes, Creando la Wallet y configurándola.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8" style="margin: 0 auto; float: none">
                            ...
                            <div class="col-md-8">
                                <ul class="item-modulos">
                                    ...
                                    <li><span>Cuidados a tener en cuenta en la mineria POSy los Master Nodes.</span>
                                    </li>
                ...
                <div class="title-content clearfix">
                    <p>
                        <a href="#" target="_blank" data-toggle="modal" data-target="#myModal"><img
                                    src="<?= asset_url(); ?>/curso/img/matricularme.png" alt="" width="280"></a>
                    </p>
                </div>
            </div>
        </div> <!-- /.container -->
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <ul class="social-list">
                    <li><a href="https://www.facebook.com/Academia-De-Trading-496295420749430/?fref=ts" target="_blank"><i
                                    class="si social-facebook" aria-hidden="true"></i></a></li>
                </ul>
                ...
                <div class="card" style="margin-bottom: 0px">
                    <div class="body auth_card">
                        ...
                        <form id="register-form" class="auth-form"
                              action="<?= site_url('auth/registro_master_node'); ?>" style="" method="POST">
                            ...
                            <div class="input-group">
                                <div class="form-line">
                                    <input type="text" id="input_referido" name="referido" class="form-control"
                                           placeholder="Numero Referido #"
                                           value="<?= (isset($referido_id)) ? $referido_id : ""; ?>" required>
                                </div>
                                <span class="input-group-addon">@<span class="referido_nombre">Referido</span></span>
                            </div>

                            <div class="col-md-12" style="margin: 0">
                                <div id="error_message" class="alert alert-danger clearfix"
                                     style="display: none;margin: 0" role="alert">
                                    Bad
                                </div>
                                <div id="success_message" class="alert alert-success clearfix" style="display: none;"
                                     role="alert">
                ...
                <div class="card" style="margin-bottom: 0px">
                    <div class="body auth_card">
                        <form id="login-form" class="auth-form" action="<?= site_url('auth/ingreso'); ?>" method="POST">
                            ...
                            <div class="row m-t-15 m-b--20">
                                <div class="col-xs-6">
                                    <a class="auth-link" data-href="register-form"
                                       href="javascript:void(0)">Registrate!</a>
                                </div>
                                <div class="col-xs-6">
                                    <a class="auth-link" data-href="forgot-form" href="javascript:void(0)">Olvido
                                        Contraseña?</a>
                                </div>
                                <div class="col-md-12" style="text-align: center">
                                    <a href="javascript:void(0)" onclick="loginFb()">
                                        <img width="230"
                                             src="https://www.thenerdmag.com/wp-content/uploads/facebook-login.png"
